...
public class StartscreenView extends View{
   ...
   //private final static float[] REGION_LOG_IN_OUT = {175/720.0f, 397/1280f, 547/720.0f, 506/1280.0f};
    ...
    private final static float[] REGION_PLAY_CIRCLE = {160/720.0f, 440/1280f, 560/720.0f, 840/1280.0f};
    ...
    private final static float[] REGION_LOG_IN_OUT = {200/720.0f, 1149/1280f, 500/720.0f, 1248/1280.0f};
    ...
    public StartscreenView(MainActivity context) {
        ...
        paintFill.setTextSize(150);

        paintHollow = new Paint();
        paintHollow.set(paintFill);
        paintHollow.setStyle(Paint.Style.STROKE);
        paintHollow.setStrokeWidth(25);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("Play", dstPlay.centerX(), dstPlay.centerY(), paintFill);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        dstPlayCircle = new Rect(    (int)(getWidth()*REGION_PLAY_CIRCLE[0]),
                            (int)(getHeight()*REGION_PLAY_CIRCLE[1]),
                            (int)(getWidth()*REGION_PLAY_CIRCLE[2]),
                            (int)(getHeight()*REGION_PLAY_CIRCLE[3]));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(event.getAction() == MotionEvent.ACTION_DOWN) {
            if(    (event.getX() > REGION_LOG_IN_OUT[0] * getWidth())
                ...
                mainActivity.startActivity(new Intent("com.rusticsam.Game"));
                ...
                mainActivity.startActivity(new Intent("com.rusticsam.About"));
            }
        }
        return true;
    }
