...
public class GameOverDialog extends Dialog {
    ...
    public void init(){
        ...
        reviveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dismiss();
                game.score -= REVIVE_PRICE * game.numberOfRevive;
                saveCoins();
                game.view.revive();
            }
        });
        if(game.score < REVIVE_PRICE * game.numberOfRevive){
    ...
    private void saveCoins(){
        SharedPreferences saveFile = game.getSharedPreferences(Game.SAVE_KEY, 0);
        saveFile.getInt(Game.SCORE_KEY, 0);
        SharedPreferences.Editor editor = saveFile.edit();
        editor.putInt(Game.SCORE_KEY, game.score);
        editor.commit();
    }
