...
public class Game extends BaseGameActivity{
    ...
    private void loadCoins(){
        SharedPreferences saves = this.getSharedPreferences(SAVE_KEY, 0);
        this.score = saves.getInt(SCORE_KEY, 0);
    }
    ...
    public void increaseCoin(){
        this.score++;
        if(score >= 50 && !accomplishmentBox.achievement_50_coins){
